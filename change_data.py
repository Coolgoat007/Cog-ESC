...
# in_file = 'output/data_base/0-60_max_Q_cmp.json'
in_file = 'output/data_ablation_no_validation_first/0-60_max_Q_cmp.json'
# in_file = 'output/data_ablation_prompt/0-60_max_Q_cmp.json'
# in_file = 'output/data_ablation_strategy/0-60_max_Q_cmp.json'
# out_file ='output/data_base/0-60_max_Q_cmp_dpo.json'
out_file ='output/data_ablation_no_validation_first/0-60_max_Q_cmp_dpo.json'
# out_file ='output/data_ablation_prompt/0-60_max_Q_cmp_dpo.json'
# out_file ='output/data_ablation_strategy/0-60_max_Q_cmp_dpo.json'
