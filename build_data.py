...
# from run_base import STRATEGY_MAP, gen_assistant, gen_user, gen_strategy, eval_all, RW_BIAS
from run_full_cognitive import STRATEGY_MAP, gen_assistant, gen_user, gen_strategy, eval_all, RW_BIAS
# from run_ablation_prompt import STRATEGY_MAP, gen_assistant, gen_user, gen_strategy, eval_all, RW_BIAS
# from run_ablation_strategy import STRATEGY_MAP, gen_assistant, gen_user, gen_strategy, eval_all, RW_BIAS
from MCTS import MCTS, Node


# tree_root = 'output/tree/run_base/0-60'
# tree_root = 'output/tree/run_full_cognitive_fix/0-60'
# tree_root = 'output/tree/run_ablation_prompt/0-60'
# tree_root = 'output/tree/run_ablation_strategy/0-60'
tree_root = 'output/tree/run_ablation_no_validation_first/0-60'

# out_root = 'output/data_base'
# out_root = 'output/data_full_cognitive_fix'
# out_root = 'output/data_ablatoin_prompt'
# out_root = 'output/data_ablation_strategy'
out_root = 'output/data_ablation_no_validation_first'
